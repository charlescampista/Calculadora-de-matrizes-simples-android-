...
public class ProdutoMatrizesActivity extends AppCompatActivity {
    ...
    private String[][] multiplicarMatrizes(String[][] matriz1, String[][] matriz2, int ordem){
        String[][] resultado = new String[ordem][ordem];
        String[][] transposta = new String[ordem][ordem];
        ...
        for(int i=0;i<ordem;i++){
            for(int j=0; j<ordem; j++){
                ...
                int b = Integer.parseInt(transposta[i][j]);
                resultado[i][j] = (a*b)+"";
            }
        }
        return resultado;
                    ...
                    if(ordem < 9){
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                String[][] resultado = multiplicarMatrizes(matriz1,matriz2,ordem);
