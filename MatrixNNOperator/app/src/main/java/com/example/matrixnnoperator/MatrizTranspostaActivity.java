...
public class MatrizTranspostaActivity extends AppCompatActivity {
    ...
    private String[][] transporMatrizes(String[][] matriz, int ordem){
                    ...
                    if(ordem < 9){
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                String[][] resultado = transporMatrizes(matriz,ordem);
