...
public class SubtrairMatrizesActivity extends AppCompatActivity {
    ...
    private String[][] subtrairMatrizes(String[][] matriz1, String[][] matriz2, int ordem) {
    ...
    private void resetarContainer() {
        ...
        container.addView(createTextView("Subtração de Matrizes"));
                    ...
                    if (ordem < 9) {
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                String[][] resultado = subtrairMatrizes(matriz1, matriz2, ordem);
