...
public class TracoMatrizActivity extends AppCompatActivity {
    ...
    private String calcularTraco(String[][] matriz, int ordem){
        int traco = 0;
        for(int i=0;i<ordem;i++){
            for(int j=0; j<ordem; j++){
                if(i == j) {
                    traco += Integer.parseInt(matriz[j][i]);
                }
            }
        }
        return "O traco da matriz é: "+traco;
    }
                    ...
                    if(ordem < 9){
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                String[][] matriz = pegarMatriz(entrada1,ordem);
                                String resultado = calcularTraco(matriz,ordem);
                                containerOperacao.addView(createTextView(resultado));
